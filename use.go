...
func Use(_ context.Context, versionStr string) error {
	...
	if err := os.WriteFile(filepath.Join(baseDir, versionFile), []byte(strings.TrimLeft(versionStr, "v")), 0644); err != nil {
		return err
	}
	return nil
}
